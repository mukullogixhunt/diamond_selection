...
class FirebasePermissionFailure extends Failure {
  const FirebasePermissionFailure({required super.message, required super.statusCode});
}

class FirebaseDocumentNotFoundFailure extends Failure {
  const FirebaseDocumentNotFoundFailure({required super.message, required super.statusCode});
}

class FirebaseGeneralFailure extends Failure {
  const FirebaseGeneralFailure({required super.message, required super.statusCode});
}
